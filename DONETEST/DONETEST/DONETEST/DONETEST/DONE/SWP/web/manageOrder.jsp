                        ...
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    ...
                                    <a class="btn btn-add btn-sm" href="formAddOrder.jsp" title="Thêm"><i class="fas fa-plus"></i>
                                        Tạo mới đơn hàng</a>
                                </div>
                                    ...
                                    <c:forEach items="${listOrders}" var="o">
                                        <tr> 
                                            ...
                                            <td style="display: flex">
                                                ...
                                                <form style="width: 35px" action="OrderDetailServlet?orderID=${o.getOrderID()}" method="post">
