            ...
            <c:if test="${requestScope.LIST !=null }">
                <c:if test="${not empty requestScope.LIST}">
                    <c:forEach var="a" varStatus="counter" items="${requestScope.LIST}">
                        <c:if test="${requestScope.leaveShift eq a.leaveShift}">
                            <div class="form-container">
                                ...
                                <form action="ProcessLeaveApplicationServlet" method="post">
                                    ...
                                    <button type="submit" name="choice" value="yes">Approve</button>
                                    <button type="submit" name="choice" value="no">Reject</button>
                                </form>
                            </div>
                        </c:if>
                    </c:forEach>
