                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex; justify-content: space-left">
                                                    ...
                                                    <form action="addemployee" method="Post">
                                                        <input type="hidden" name="employeeID" value="${i.employeeID}">
                                                        <button class="btn btn-primary btn-sm edit" type="submit" title="Thêm nhân viên làm việc" onclick="confirmAdd(event)">
                    ...
                    <div class="modal-body">
                        ...
                        <script>
                            function confirmAdd(event) {
                                ...
                                swal({
                                    title: "Thông báo ",
                                    text: "Bạn có muốn thêm nhân viên này trở lại ?",
                                    buttons: ["Hủy bỏ", "Đồng ý"],
                                }).then((willDelete) => {
                                    if (willDelete) {
                                        var redirectURL = "user";
                                        var addURL = "addemployee?employeeID=" + employeeID + "&redirect=" + encodeURIComponent(redirectURL);
