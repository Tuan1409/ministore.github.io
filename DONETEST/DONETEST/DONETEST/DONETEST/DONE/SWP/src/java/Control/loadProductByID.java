    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<form action=\"update\" method=\"POST\" id=\"updatesp\">\n"
                    ...
                    + "                                    <input class=\"form-control\" type=\"number\" name=\"giasp\" value=\"" + p.getProductPrice() + "\" >\n"
                    + "                                </div>\n"
                    + "                                <div class=\"form-group col-md-6\">\n"
                    + "                                    <label class=\"control-label\">Số lượng</label>\n"
                    + "                                    <input class=\"form-control\" type=\"number\" name=\"quantity\" value=\"" + p.getQuantity() + "\" >\n"
                    + "                                </div>\n"
                    + "                                <div class=\"form-group col-md-6\">\n"
                    + "                                    <label class=\"control-label\">Discount</label>\n"
                    + "                                    <input class=\"form-control\" type=\"number\" name=\"discountsp\" value=\"" + p.getProductPrice() + "\" >\n"
                    + "                                </div>\n"
                    + "                                <div class=\"form-group col-md-6\">\n"
