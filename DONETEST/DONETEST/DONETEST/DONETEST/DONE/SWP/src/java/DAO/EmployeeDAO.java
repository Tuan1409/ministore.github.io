...
public class EmployeeDAO {
    ...
    public Employee detailsEmployee(String username, String password) {
        try {
            ...
            while (rs.next()) {
                ...
                Employee emp = new Employee(employeeID, employeeName, employeeAvatar, Username, birthday, employeeSex, employeePassword, employeeAddress, employeePhone, role, employeeStatus);
                return emp;
            }
        } catch (SQLException ex) {
    ...
    public Employee getEmployeeByID(String id) {
        String sql = "SELECT e.EmployeeID, e.EmployeeName, e.EmployeeAvatar, e.EmployeeAddress, "
        ...
        try {
            ...
            if (rs.next()) {
                ...
                p.setEmployeesex(rs.getInt(6));
                p.setEmployeephone(rs.getString(7));
                p.setEmprole(new Role(rs.getInt(8), rs.getString(9)));
                p.setEmployeestatus(rs.getBoolean(10));
                return p;
            }
        } catch (SQLException e) {
        } finally {
    ...
    public void updateuser(String id, String name, String address, String birthday, String sex, String phone, String role) {
