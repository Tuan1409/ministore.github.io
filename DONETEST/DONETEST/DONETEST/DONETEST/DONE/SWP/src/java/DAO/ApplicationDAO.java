...
public class ApplicationDAO {
    ...
    public void SendLeaveApplication(String ID, String leaveShift, String leaveReason) throws SQLException {
...
//                        + "WHERE e.EmployeeName = N?");
    ...
    public void ProcessLeaveApplication(String choice, String employeeID, String leaveReason, String leaveShift) {
        String approve = "UPDATE Applications SET IsApproved = 1, ApplicationStatus = 1 WHERE EmployeeID = ? and LeaveReason = ? UPDATE Shifts SET EmployeeID = null, WorkStatus = 2 WHERE EmployeeID = ? AND WorkStatus = 1 AND ShiftID = ?";
