 ...
 * @author Vuong
 */
public class WorkSheet_showdetail extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Employee> dto = dao.getEmployeeinfo(employeeid);
        request.setAttribute("LIST",dto);
       
        request.getRequestDispatcher("WorkSheet_showdetail.jsp").forward(request, response);
